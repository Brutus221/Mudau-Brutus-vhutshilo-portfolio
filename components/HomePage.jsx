...
<div id="home" className="w-full">
      ...
      <div className="flex flex-col md:flex-row gap-8 shadow-xl shadow-blue-300 bg-black mt-4">
        ...
        <Link href="/#About_me">
          <div className="group flex items-center justify-center my-8 bg-blue-500 text-white px-7 py-4 font-bold uppercase rounded-md tracking-wider cursor-pointer">
            Experience
